...
const navigationItems = [
  { title: 'About', tag: 'Who I am', href: '#about', color: '#f26d5b', position: [-2.85, 1.15, -0.45], rotation: [0.05, 0.35, -0.09], size: 1 },
  { title: 'Projects', tag: 'Things I build', href: './projects.html', color: '#36c5f0', position: [1.55, 1.15, 0.15], rotation: [0.14, -0.32, 0.06], size: 1 },
  { title: 'Blog', tag: 'Notes and ideas', href: './blog.html', color: '#f4b942', position: [-1.65, -1.18, 0.3], rotation: [-0.1, -0.42, 0.08], size: 1 },
  { title: 'Contact', tag: 'Say hello', href: '#contact', color: '#8bd450', position: [2.35, -1.05, -0.5], rotation: [-0.08, 0.36, -0.04], size: 1 },
  { title: 'GitHub', tag: 'Code', href: 'https://github.com/Cobse/', color: '#f7f7f7', position: [-0.2, 0.16, 0.8], rotation: [0.2, -0.21, 0.08], size: 0.62, external: true },
  { title: 'LinkedIn', tag: 'Connect', href: 'https://www.linkedin.com/in/fredrikjacobsen', color: '#5aa7ff', position: [0.62, -0.38, 0.95], rotation: [-0.24, 0.28, -0.11], size: 0.62, external: true },
];
  ...
  return (
    React.createElement(React.Fragment, null,
      React.createElement(Canvas, {
        ...
        React.createElement('color', { attach: 'background', args: ['#101010'] }),
        ...
        React.createElement(Suspense, { fallback: null },
          navigationItems.map((item, index) => React.createElement(NavigationTile, { key: item.title, item, index }))
        )
      ),
